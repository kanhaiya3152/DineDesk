...
export default function Restaurant() {
  ...
  const getRestaurantData = async () => {
    try {
      ...
      const restaurantSnapshot = await getDocs(restaurantQuery); // snapshot means to store the data temporary and use it
      ...
      for (const doc of restaurantSnapshot.docs) {
        ...
        // carousel data from db
        const carouselQuery = query(
          collection(db, "carousel"),
          where("res_id", "==", doc.ref)  // make sure the ref_id is a reference type
        );

        const carouselSnapshot = await getDocs(carouselQuery);

        const carouselImages = []; // coz all the images store in the array
